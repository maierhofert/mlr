...
makeRLearner.fcregr.tbats = function() {
  makeRLearnerForecastRegr(
    ...
    par.set = makeParamSet(
      makeLogicalLearnerParam(id = "use.box.cox", default = NULL),
      makeLogicalLearnerParam(id = "use.trend", default = NULL),
      makeLogicalLearnerParam(id = "use.damped.trend", default = NULL),
